...
| Skill | คำสั่ง | ทำอะไร |
|:--|:--|:--|
| **[save](save/SKILL.md)** 🎮 | `/save` · `/save ต่อ` | จุดเซฟแบบเกมของโปรเจค — เซฟงานค้างเป็นไฟล์ถาวร 1 ไฟล์ต่อ 1 โปรเจค ข้าม session ไม่หาย · ใช้ร่วม **ข้าม AI** ได้ (Claude / Codex อ่านเขียนไฟล์เดียวกัน) |
...
- 🗂️ เก็บที่ `~/.handoffs/<โปรเจค>.md` — ตำแหน่งกลาง แยกไฟล์ตามโปรเจคอัตโนมัติ
- 🤝 **ข้าม AI ได้** — เซฟด้วย Claude แล้วเปิด Codex พิมพ์ `/save` โหลดต่อได้เลย (ไฟล์ชุดเดียวกัน)
